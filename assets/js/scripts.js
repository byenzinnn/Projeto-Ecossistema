...
const images = [
  '/assets/img/Fotos-paquistao.png',
  '/assets/img/Fotos-paquistao-3.png',
  '/assets/img/Fotos-paquistao-2.png'
];
...
const items = [...acc.querySelectorAll('.acc-item')];
  ...
  // prepara alturas (abre o que tem aria-expanded="true")
  items.forEach(it => {
...
function closeItem(it){
  ...
  it.querySelector('.acc-head').focus(); // Adiciona foco para acessibilidade
}
...
acc.addEventListener('click', (e) => {
  ...
  // Comportamento de acordeão exclusivo: fecha outros abertos
